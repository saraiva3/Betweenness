...
public class Main {
	...
	public static void main(String args[]) {
		...
		//args[0]= "C:\\Users\\Lucas\\Documents\\GitHub\\Betweenness\\Politics_Graph\\src\\Teste.txt";
		//args[1]= "saida.txt";
		try {
			...
			while (true) {
				...
				graph.addConnection(Integer.parseInt(values[0]), Integer.parseInt(values[1]), Double.parseDouble(values[2]));
			}
			...
			while (v1 != null) {
				...
				while (v2 != null) {
					...
					if(v2.getFatherList() != null) {
						computeBetwenness.computeAllPathsFromPrev(graph, v2,v2.getFatherList().size());
					}
